...
Website Jual Beli Beras dan Sayur

Membuat sebuah situs website yang memfasilitasi penjualan beras dan sayur secara online dengan fitur-fitur yang memudahkan pengguna dalam bertransaksi
...
a. Fitur Pengguna: 
    ...
    1. Pilihan Produk 
    - Kategori Beras: Jenis: Beras Putih, Beras Merah, Beras Organik 
    - Ukuran: 5 kg, 10 kg, 25 kg. 
    - Varietas: Pandan Wangi, IR64, Rojolele, dil 
    - Kategori Sayur: Sayuran Hijau. Bayam, Kangkung, Sawi, dll. 
    ...
    4.  Pembayaran 
        - Pilihan Metode Pembayaran: Transfer Bank, E-Wallet (OVO, GoPay, Dana), COD (Cash on Delivery) 
    ...
    11. Pengembalian Produk (Return/Refund) 
        ...
        • Pilihan alasan pengembalian: Produk rusak, Produk salah kirim, Produk tidak sesuai deskripsi, Lainnya (dengan kolom input tambahan). 
